        ...
        $(document).ready(function () {
            ...
            $.each(res.productInfoMap,function(ky,vl) {
            	...
            	$.each(vl,function(cky,cvl) {
	            	$("input[name=skuId]").val(cvl.proskuid);
	            	$("input[name=skuSellPrice]").val(cvl.sellprice);
	            	$("input[name=discountPrice]").val(cvl.discountprice);
            	});
            });
            ...
            $("#formSubmit").on("click",function(e){
        		...
        		// 富文本编辑器
        		form.action = "${_ContextPath}/product/modifyCardInfo"; 
                form.method = "post";  
                form.submit();  
