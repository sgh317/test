                    ...
                    <div class="ibox-content">
                        <form class="form-horizontal m-t" id="signupForm">
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <select class="form-control m-b" name="adLocation" id="classifyId"></select>
                                </div>
                            </div>
                            <div class="form-group">
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $.ajax({contentType:"application/x-www-form-urlencoded; charset=UTF-8",
       			...
       			success:function(result){
       				if(result){
		        		var res = eval('('+result+')');
		        		var classifyList = res.CatalogList;
            ...
            $("#formSubmit").on("click",function(e){
        		...
        		// 富文本编辑器
                form.action = "${_ContextPath}/ad/saveAdInfo";  
                form.method = "post";  
                form.submit();
        ...
        jQuery(function() {
            ...
            uploader.on('uploadSuccess', function (file, response) {//上传成功事件
            	...
            	if(null == $("#photoAlbumImage").val()) {
            		$("#photoAlbumImage").val(fileNameStr)
            	} else {
	            	fileNameStr = fileNameStr + "," +$("#photoAlbumImage").val();
	            	$("#photoAlbumImage").val(fileNameStr.substring(0,fileNameStr.length - 1))
            	}
            });
